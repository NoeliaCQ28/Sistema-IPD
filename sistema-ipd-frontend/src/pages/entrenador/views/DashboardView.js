        ...
        <div className="view-container dashboard-view">
            ...
            <div className="dashboard-widgets">
                ...
                <div className="widget">
                        ...
                        {horariosRecientes.length > 0 ? horariosRecientes.map(h => (
                           <li key={h.id} className="widget-list-item">
                                <div className="widget-item-info">
                                    ...
                                    <span className="item-deportista">Para: {h.deportistaNombre || 'No asignado'}</span>
                                </div>
                            </li>
                        )) : (
                    ...
                    <Link to="/portal/entrenador/horarios" className="widget-link">Ver calendario completo &rarr;</Link>
                </div>
            </div>
        </div>
    );
